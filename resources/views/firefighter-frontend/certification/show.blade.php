...
@section('content')
    <div class="pl-3">
        ...
        <div class="row">
            <div class="col-md-6">
                @include('partials.meta-box',['labels'=>['Credential ID:'=>$certificate->prefix_id]])
            </div>
                        ...
                        <div class="col-md-6">
                            <table class="table table-borderless w-100 mb-0">
                                <tr>
                                    ...
                                    <td>
                                        <div class="show-field">{{ $certificate->no_of_pre_req_cert }}</div>
                                    </td>
                                </tr>
                            </table>
                            <div class="show-field">
                        ...
                        <div class="col-md-6">
                            <table class="table table-borderless w-100 mb-0">
                                <tr>
                                    ...
                                    <td>
                                        <div class="show-field">{{ $certificate->no_of_pre_req_course }}</div>
                                    </td>
                                </tr>
                            </table>
                            <div class="show-field">
