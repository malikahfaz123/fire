...
@section('content')
    <div class="pl-3">
        <div class="page-title mb-4">
            <h3>Rejected Credentials</h3>
        </div>
        <div class="row mb-4">
            <div class="col-md-6">
                @include('partials.meta-box',['labels'=>['Total Credentials:'=> $certifications->count]])
            </div>
                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="form-group">
                            <label for="id">Credentials Code</label>
                            <input type="search" name="prefix_id" class="form-control">
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group selectpicker-custom-style">
                            <label for="type">Credentials Title</label>
                            <input type="search" name="credential_title" class="form-control">
                        </div>
                    </div>
...
@push('js')
    ...
    <script>
        ...
        function load_records(page, url){
            ...
            url = url ? url : `{{ route('firefighters.reject-certificates.paginate') }}?${form}&page=${page}`;
        ...
        function reload_current_page(){
            ...
            url = `{{ route('firefighters.reject-certificates.paginate') }}?${req}&page=${page}`;
