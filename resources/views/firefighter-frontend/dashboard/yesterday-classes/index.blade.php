...
@section('content')
    <div class="pl-3">
        <div class="page-title">
            <h3>Yesterday's Classes</h3>
        </div>
        <div class="row mb-4">
            <div class="col-md-6">
                <span class="segoe-ui-italic">Dashboard > Yesterday's Classes</span>
            </div>
        </div>
        <div class="row mb-3">
            <div class="col-md-6">
...
@push('js')
    <script>
        ...
        function load_records(page, url){
            ...
            url = url ? url : `{{ route('firefighters.yesterday-classes.paginate') }}?page=${page}`;
