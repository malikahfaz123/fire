                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="show-field">
                                <table class="table table-borderless w-100 mb-0 {{ $certificate->renewal_period ? '' : 'd-none' }}">
                                    <tr>
                                        <th width="170">
                                ...
                                @if($firefighter_certificates_details && $firefighter_certificates_details->count())
                                    @foreach($firefighter_certificates_details as $firefighter_certificates_details)
                                        <tr>
                                            ...
                                            <td class="text-capitalize"> {{ $firefighter_certificates_details->test_status }} </td>
                                        </tr>
                                    @endforeach
                                @else
