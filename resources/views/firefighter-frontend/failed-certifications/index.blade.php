...
@section('content')
    <div class="pl-3">
        <div class="page-title mb-4">
            <h3>Failed Credentials</h3>
        </div>
        <div class="row mb-4">
            <div class="col-md-6">
                @include('partials.meta-box',['labels'=>['Total Credentials:'=> $certifications]])
            </div>
...
@push('js')
    ...
    <script>
        ...
        function load_records(page, url){
            ...
            url = url ? url : `{{ route('firefighters.failed-certificates.paginate') }}?${form}&page=${page}`;
        ...
        function reload_current_page(){
            ...
            url = `{{ route('firefighters.failed-certificates.paginate') }}?${req}&page=${page}`;
