@extends('layouts.firefighters-app',['title'=>''])
@push('head')
    ...
    <div class="pl-3">
        ...
        <div class="row mb-4">
            <div class="col-md-6">
                ...
                @include('partials.meta-box',['labels'=>['Total Classes: '=> $firefighter_classes_count  ]])
            </div>
...
@push('js')
    ...
    <script>
        ...
        function load_records(page, url){
            ...
            url = url ? url : `{{ route('firefighters.classes.paginate',$course_id) }}?${form}&page=${page}`;
