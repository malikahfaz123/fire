                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="form-group selectpicker-custom-style">
                            <label for="type">Credential Title</label>
...
@push('js')
    ...
    <script>
        ...
        function load_records(page, url){
            ...
            url = url ? url : `{{ route('firefighters.apply-certificates.paginate') }}?${form}&page=${page}`;
        ...
        function reload_current_page(){
            ...
            url = `{{ route('firefighters.apply-certificates.paginate') }}?${req}&page=${page}`;
