...
@section('content')
    <div class="pl-3">
        ...
        <div class="row mb-4">
            <div class="col-md-6">
                @include('partials.meta-box',['labels'=>['Total Personnel:'=>$firefighters->count]])
            </div>
            <div class="col-md-6 text-right">
                @can('firefighters.create')
                      <a href="{{ route('firefighter.create') }}" class="btn btn-primary btn-wd"><span class="material-icons">add</span>Add Personnel</a>
                @endcan
                <a href="{{ route('firefighter.archive') }}" class="btn btn-secondary btn-wd"><span class="material-icons">archive</span> Archived Personnel</a>
            </div>
        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="form-group selectpicker-custom-style">
                            ...
                            <select name="type[]" class="form-control selectpicker" title="Choose an option" multiple>
                                <option value="fire inspector">Fire inspector</option>
                                <option value="fire official">Fire official</option>
                                <option value="fire instructor">Fire instructor</option>
                            </select>
                        </div>
                    </div>
                    {{-- <div class="col-md-3">
                        <div class="form-group selectpicker-custom-style">
                            ...
                            <input type="search" name="ssn" class="form-control numeric-only" minlength="11" maxlength="11">
                        </div>
                    </div> --}}
                    {{-- <div class="col-md-3">
                        <div class="form-group selectpicker-custom-style" data-dropup-auto="false">
...
@push('js')
    ...
    <script>
        ...
        function load_records(page, url){
            ...
            url = url ? url : `{{ route('firefighter.paginate') }}?${form}&page=${page}`;
        ...
        function reload_current_page(){
            ...
            url = `{{ route('firefighter.paginate') }}?${req}&page=${page}`;
