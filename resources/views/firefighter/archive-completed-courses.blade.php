...
@section('content')
    <div class="pl-3">
        <div class="page-title">
            <h3>Archived Completed Courses</h3>
        </div>
        <div class="row mb-4">
            <div class="col-md-6">
                <span class="segoe-ui-italic">Personnel > View Personnel > Courses > View Completed Courses > Archived Courses</span>
            </div>
        </div>
        <div class="row mb-4">
            <div class="col-md-6">
                @include('partials.meta-box',['labels'=>['DFSID:'=>$firefighter->prefix_id,'Archived Courses:'=> $completed_courses->count]])
            </div>
...
@push('js')
    ...
    <script>
        ...
        function load_records(page, url){
            ...
            url = url ? url : `{{ route('completed-course.paginate',$firefighter->id) }}?${form}&is_archive=1&page=${page}`;
        ...
        function reload_current_page(){
            ...
            url = `{{ route('completed-course.paginate',$firefighter->id) }}?${req}&is_archive=1&page=${page}`;
        ...
        *=============================*/
        ...
        $('#archive-form').on('submit',function (e) {
            ...
            axios.post("{{ route('completed-course.unarchive') }}",$(this).serialize()).then((response)=>{
