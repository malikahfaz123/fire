...
@section('content')
    <div class="pl-3">
        <div class="page-title">
            <h3>Archived Personnel</h3>
        </div>
        <div class="row mb-4">
            <div class="col-md-6">
                <span class="segoe-ui-italic">Personnel > Archived Personnel</span>
            </div>
        </div>
        <div class="row mb-4">
            <div class="col-md-6">
                @include('partials.meta-box',['labels'=>['Total Archived:'=>$firefighters->count],'icon'=>'archive'])
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="form-group selectpicker-custom-style">
                            ...
                            <input type="search" name="ssn" class="form-control">
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group selectpicker-custom-style">
...
@push('js')
    ...
    <script>
        ...
        function load_records(page, url){
            ...
            url = url ? url : `{{ route('firefighter.paginate') }}?${form}&is_archive=1&page=${page}`;
        ...
        function reload_current_page(){
            ...
            url = `{{ route('firefighter.paginate') }}?${req}&is_archive=1&page=${page}`;
