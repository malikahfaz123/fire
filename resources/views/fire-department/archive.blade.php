...
@section('content')
    <div class="pl-3">
        ...
        <div class="row mb-4">
            <div class="col-md-6">
                <span class="segoe-ui-italic">Fire Departments > Archived Fire Departments</span>
            </div>
        </div>
        <div class="row mb-4">
            <div class="col-md-6">
                @include('partials.meta-box',['labels'=>['Archived Fire departments:'=>$fire_departments->count],'icon'=>'archive'])
            </div>
...
@push('js')
    ...
    <script>
        ...
        function load_records(page, url){
            ...
            url = url ? url : `{{ route('fire-department.paginate') }}?${form}&is_archive=1&page=${page}`;
        ...
        function reload_current_page(){
            ...
            url = `{{ route('fire-department.paginate') }}?${req}&is_archive=1&page=${page}`;
