...
@section('content')
    <div class="pl-3">
        ...
        <div class="row mb-4">
            <div class="col-md-6">
                @include('partials.meta-box',['labels'=>['Total Fire Departments:'=>$fire_departments->count]])
            </div>
            <div class="col-md-6 text-right">
                @can('fire_departments.create')
                    <a href="{{ route('fire-department.create') }}" class="btn btn-primary btn-wd"><span class="material-icons">add</span> Add Fire department</a>
                @endcan
                <a href="{{ route('fire-department.archive') }}" class="btn btn-secondary btn-wd"><span class="material-icons">archive</span> Archived Fire departments</a>
            </div>
        </div>
                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="form-group">
                            <label for="id">Fire Dept. ID</label>
                            <input type="search" name="prefix_id" class="form-control">
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                            <label for="name">Fire Dept. Name</label>
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="search" name="city" class="form-control">
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
...
@push('js')
    ...
    <script>
        ...
        function load_records(page, url){
            ...
            url = url ? url : `{{ route('fire-department.paginate') }}?${form}&page=${page}`;
        ...
        function reload_current_page(){
            ...
            url = `{{ route('fire-department.paginate') }}?${req}&page=${page}`;
