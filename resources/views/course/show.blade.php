        ...
        <div class="row">
            ...
            <div class="col-md-6 text-right">
                ...
                @if(!empty($semester_id))
                    <a href="{{ route('course.view-firefighters',[$semester_id,$course->id]) }}" class="btn btn-primary btn-wd"><span class="material-icons">view_list</span> View Firefighters</a>
                    <a href="{{ route('class.index',[$semester_id,$course->id]) }}" class="btn btn-primary btn-wd"><span class="material-icons">school</span> View Classes</a>
                @endif
                @can('courses.update')
...
{{--                                </tr>--}}
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="show-field">{{ $course->maximum_students }}</div>
                                        <div class="edit-field d-none">
...
{{--                                    <td>--}}
{{--                                        <div class="show-field">{{ $course->no_of_pre_req_course }}</div>--}}
{{--                                        <div class="edit-field d-none">--}}
...
{{--                            </div>--}}
                            ...
                            <table class="table table-borderless w-100 mb-0 edit-field d-none">
                                <tr>
                                    <th width="170">
                            ...
                            <table class="table table-borderless w-100 mb-0">
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="show-field">{{ $course->comment }}</div>
                                            <div class="edit-field d-none">
...
<script type="text/javascript">
    ...
    $("#group_credit_types").select2({ placeholder: "Select Credit Type" });
