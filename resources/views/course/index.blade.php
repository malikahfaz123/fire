...
@section('content')
    <div class="pl-3">
        ...
        <div class="row mb-4">
            <div class="col-md-6">
                @include('partials.meta-box',['labels'=>['Total Courses:'=>$courses->count]])
            </div>
            <div class="col-md-6 text-right">
                @can('courses.create')
                    <a href="{{ route('course.create') }}" class="btn btn-primary btn-wd"><span class="material-icons">add</span> Add Course</a>
                @endcan
                {{-- <a href="{{ route('course.archive') }}" class="btn btn-secondary btn-wd"><span class="material-icons">archive</span> Archived Courses</a> --}}
            </div>
        </div>
...
@push('js')
    ...
    <script>
        ...
        function load_records(page, url){
            ...
            url = url ? url : `{{ route('course.paginate') }}?${form}&page=${page}`;
        ...
        function reload_current_page(){
            ...
            url = `{{ route('course.paginate') }}?${req}&page=${page}`;
