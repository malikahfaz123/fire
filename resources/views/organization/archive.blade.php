...
@section('content')
    <div class="pl-3">
        ...
        <div class="row mb-4">
            <div class="col-md-6">
                <span class="segoe-ui-italic">Eligible Organizations > Archived Organizations</span>
            </div>
        </div>
        <div class="row mb-4">
            <div class="col-md-6">
                @include('partials.meta-box',['labels'=>['Archived Eligible Organizations:'=>$organizations->count],'icon'=>'archive'])
            </div>
...
@push('js')
    ...
    <script>
        ...
        function load_records(page, url){
            ...
            url = url ? url : `{{ route('organization.paginate') }}?${form}&is_archive=1&page=${page}`;
        ...
        function reload_current_page(){
            ...
            url = `{{ route('organization.paginate') }}?${req}&is_archive=1&page=${page}`;
