...
@section('content')
    <div class="pl-3">
        ...
        <div class="row mb-4">
            <div class="col-md-6">
                @include('partials.meta-box',['labels'=>['Total Eligible Organization:'=>$organizations->count]])
            </div>
            <div class="col-md-6 text-right">
                @can('organizations.create')
                    <a href="{{ route('organization.create') }}" class="btn btn-primary btn-wd"><span class="material-icons">add</span> Add Eligible Organization</a>
                @endcan
                <a href="{{ route('organization.archive') }}" class="btn btn-secondary btn-wd"><span class="material-icons">archive</span> Archived Eligible Organization</a>
            </div>
        </div>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group selectpicker-custom-style">
                            <label for="id">Eligible Organization ID</label>
                            <input class="form-control" name="prefix_id">
                        </div>
                    </div>
                    <div class="col-md-3">
                        <label for="id">Eligible Organization Name</label>
...
@push('js')
    ...
    <script>
        ...
        function load_records(page, url){
            ...
            url = url ? url : `{{ route('organization.paginate') }}?${form}&page=${page}`;
        ...
        function reload_current_page(){
            ...
            url = `{{ route('organization.paginate') }}?${req}&page=${page}`;
