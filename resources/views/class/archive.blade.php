...
@section('content')
    <div class="pl-3">
        ...
        <div class="row mb-4">
            <div class="col-md-6">
                <span class="segoe-ui-italic">Training Details > Courses > View Course > View Classes > Archived Classes</span>
            </div>
        </div>
        <div class="row mb-4">
            <div class="col-md-6">
                @include('partials.meta-box',['icon'=>'archive','labels'=>['Archived Classes:'=>$classes->count]])
            </div>
...
@push('js')
    ...
    <script>
        ...
        function load_records(page, url){
            ...
            url = url ? url : `{{ route('class.paginate',$course->id) }}?${form}&is_archive=1&page=${page}`;
        ...
        function reload_current_page(){
            ...
            url = `{{ route('class.paginate',$course->id) }}?${req}&is_archive=1&page=${page}`;
        ...
        *=============================*/
        ...
        $('#delete-form').on('submit',function (e) {
            ...
            axios.delete("{{ route('class.index',$course->id) }}/"+$('[name=delete]').val(),$(this).serialize()).then((response)=>{
