...
@section('content')
    <div class="pl-3">
        <div class="page-title">
            <h3>Archived Facilities</h3>
        </div>
        <div class="row mb-4">
            <div class="col-md-6">
                <span class="segoe-ui-italic">Facilities > Archived Facilities</span>
            </div>
        </div>
        <div class="row mb-4">
            <div class="col-md-6">
                @include('partials.meta-box',['labels'=>['Total Archived Facilities:'=>$facilities->count]])
            </div>
        ...
        <div class="filter-container">
            ...
            <form id="filter" action="#" novalidate>
                <div class="row">
                    ...
                    <div class="col-md-2 selectpicker-custom-style">
                        <div class="form-group selectpicker-custom-style">
...
@push('js')
    ...
    <script>
        ...
        function load_records(page, url){
            ...
            url = url ? url : `{{ route('facility.paginate') }}?${form}&is_archive=1&page=${page}`;
        ...
        function reload_current_page(){
            ...
            url = `{{ route('facility.paginate') }}?${req}&is_archive=1&page=${page}`;
