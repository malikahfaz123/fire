...
@section('content')
    <div class="pl-3">
        ...
        <div class="row mb-4">
            <div class="col-md-6">
                @include('partials.meta-box',['labels'=>['Total Users:'=>$users->count]])
            </div>
            <div class="col-md-6 text-right">
                @can('settings.create')
                <a href="{{ route('user.create') }}" class="btn btn-primary btn-wd"><span class="material-icons">add</span> Add user</a>
                @endcan
                <a href="{{ route('user.archive') }}" class="btn btn-secondary btn-wd"><span class="material-icons">archive</span> Archived users</a>
            </div>
        </div>
...
@push('js')
    ...
    <script>
        ...
        function load_records(page, url){
            ...
            url = url ? url : `{{ route('user.paginate') }}?${form}&page=${page}`;
        ...
        function reload_current_page(){
            ...
            url = `{{ route('user.paginate') }}?${req}&page=${page}`;
