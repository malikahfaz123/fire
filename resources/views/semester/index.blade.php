...
@section('content')
    <div class="pl-3">
        ...
        <div class="row mb-4">
            <div class="col-md-6">
                @include('partials.meta-box',['labels'=>['Total Semesters:'=>$semesters->count]])
            </div>
            <div class="col-md-6 text-right">
                @can('semesters.create')
                    <a href="{{ route('semester.create') }}" class="btn btn-primary btn-wd"><span class="material-icons">add</span> Add Semester</a>
                @endcan
                <a href="{{ route('semester.archive') }}" class="btn btn-secondary btn-wd"><span class="material-icons">archive</span> Archived Semesters</a>
            </div>
        </div>
...
@push('js')
    ...
    <script>
        ...
        function load_records(page, url){
            ...
            url = url ? url : `{{ route('semester.paginate') }}?${form}&page=${page}`;
        ...
        function reload_current_page(){
            ...
            url = `{{ route('semester.paginate') }}?${req}&page=${page}`;
