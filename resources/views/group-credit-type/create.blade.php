                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="selectpicker-custom-style">
                                            <input type="text" class="form-control" name="credit_code" id="group_name">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <select name="credit_types[]" multiple="multiple" class="form-control"  id="credit-types-select2">
                                                <option value="">Choose an option</option>
                                                @foreach ($credit_types as $item)
...
@push('js')
    ...
    <script type="text/javascript">
        ...
        $('#add').on('submit',function (e) {
            ...
            axios.post("{{ route('group-credit-types.store') }}",$(this).serialize()).then((response)=>{
