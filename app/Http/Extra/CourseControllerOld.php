...
//        }
        ...
        //     $rules['pre_req_courses'] = 'required|array';
...
//                throw \Illuminate\Validation\ValidationException::withMessages([
//                    'pre_req_courses' => ['The Pre-requisite Courses field is required.']
//                ]);
...
//        $course->admin_ceu = $request->admin_ceu;
//        $course->tech_ceu = $request->tech_ceu;
        $course->course_hours = $request->course_hours;
        $course->no_of_credit_types = $request->no_of_credit_types;
//        $course->no_of_pre_req_course = $request->no_of_pre_req_course;
