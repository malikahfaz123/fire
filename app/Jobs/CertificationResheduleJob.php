...
use App\Mail\CertificationReshedule;
use Mail;
use Carbon\Carbon;

class CertificationResheduleJob implements ShouldQueue
{
    ...
    {
        $email = (new CertificationReshedule($this->firefighter,$this->certification,$this->test_date,$this->test_time,$this->subject))->delay(Carbon::now()->addSeconds(3));
