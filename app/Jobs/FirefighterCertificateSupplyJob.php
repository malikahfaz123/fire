...
use App\Mail\FirefighterCertificateSupply;
use Mail;
use Carbon\Carbon;


class FirefighterCertificateSupplyJob implements ShouldQueue
{
    ...
    {
        $email = (new FirefighterCertificateSupply($this->admin_name,$this->firefighter_email,$this->firefighter_f_name,$this->firefighter_m_name,$this->firefighter_l_name,$this->cell_phone,$this->certificate,$this->subject))->delay(Carbon::now()->addSeconds(3));
